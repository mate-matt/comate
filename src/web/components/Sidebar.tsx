import { CalendarDays, Clock3, Image, MessageSquareText } from "lucide-react";
    ...
    <aside className="sidebar">
      <nav className="filter-group" aria-label="Date filters">
        {DATE_FILTERS.map((filter) => (
          ...
          >
            {filter.value === "all" ? <Image size={16} /> : filter.value === "today" ? <Clock3 size={16} /> : <CalendarDays size={16} />}
